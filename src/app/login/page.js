...
const LoginPage = () => {
  ...
  return (
    <div className='m-7 md:w-[30%] md:m-auto'>
        ...
        <div className='mt-2'>
            <p className='text-center text-sm text-[#686963]'>Don't have an account? <button className='font-bold hover:text-gray-700 hover:cursor-pointer' onClick={() => window.location.href = '/signup'}>Sign Up</button></p>
        </div>
    </div>
  )
}
